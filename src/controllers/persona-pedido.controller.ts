...
export class PersonaPedidoController {
  ...
  async find(
    ...
    return this.personaRepository.y(id).find(filter);
  }
  ...
  async create(
    ...
    return this.personaRepository.y(id).create(pedido);
  }
  ...
  async patch(
    ...
    return this.personaRepository.y(id).patch(pedido, where);
  }
  ...
  async delete(
    ...
    return this.personaRepository.y(id).delete(where);
  }
}
